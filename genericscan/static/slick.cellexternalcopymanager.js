  ...
  function CellExternalCopyManager(options) {
    ...
    */
    ...
    function init(grid) {
      ...
      cellSelectionModel.onSelectedRangesChanged.subscribe(handleRangeChange);
    }

    function destroy() {
      _grid.onKeyDown.unsubscribe(handleKeyDown);
      cellSelectionModel = _grid.getSelectionModel();
      cellSelectionModel.onSelectedRangesChanged.unsubscribe(handleRangeChange);
    }
    ...
    function handleRangeChange(e, args) {
      _grid.focus();
    }
